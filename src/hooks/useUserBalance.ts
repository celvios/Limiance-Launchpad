...
export function useUserBalance() {
  ...
  return {
    ...
    totalAvailableUSDT,
    isLoading: (!wallet) || balanceQuery.isPending || depositAddressQuery.isPending,
    isLoadingAddress: (!wallet) || depositAddressQuery.isPending || depositAddressQuery.isFetching,
